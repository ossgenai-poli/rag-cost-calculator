...
const DEFAULTS: AdvisorState = {
  ...
  chunkSize: 512, topN: 5, topK: 20, uptimeHours: 730, utilTargetPct: 70, haEnabled: true, purchasingModel: "on-demand", experimental: false, peakFactor: 1, ranges: {}, selectedCandidateId: null,
};
